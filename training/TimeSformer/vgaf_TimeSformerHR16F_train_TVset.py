...
num_frames = 16
N_EPOCHS = 20
model_name = "TimeSformerHR"
training_set = "TVset" # Tset or TVset
...
model = TimeSformer(img_size=224, num_classes=400, num_frames=16, attention_type='divided_space_time',  pretrained_model='TimeSformer_divST_16x16_448_K400.pyth')
